...
function ca(a){if(a.constructor===Array){for(var b=0;b<a.length;b++){var c=a[b];a[b]="string"===typeof c?document.querySelector(c):c}return a}return"string"===typeof a?document.querySelectorAll(a):[a]}function l(a,b){return(b||document).getElementsByClassName(a)};function fa(a,b,c,d){ha("add",a,b,c,d)}function ia(a,b,c,d){ha("remove",a,b,c,d)}function ha(a,b,c,d,f){b[a+"EventListener"](c||"click",d,"undefined"===typeof f?!0:f)}function p(a,b){a||(a=window.event);a&&(b||a.preventDefault(),a.stopImmediatePropagation(),a.returnValue=!1);return!1};var q="theme fullscreen autofit zoom-in zoom-out page title description player".split(" "),r,t,ja,ka,u,v,w,x,y,la=!1,ma=!1,z=!1,A=!1,B=!1,D=!1,E,F,G,H,I,J,K,L,M,N,oa,pa,qa,ra,O,sa,P,Q=null,R=null,S=null,T,ta;
function ua(a,b){if(F=a.length){K||(K=l("pane",M));for(var c=K.length,d=G.title,f=G.description,e=0;e<F;e++){var m=a[e];if(e<c)var n=K[e];else n=K[0].cloneNode(!0),k(n,"left",100*e+"%"),K[0].parentNode.appendChild(n);var C=void 0;n=n.dataset;n.src=m.href||m.src;var W=m.dataset;if("false"!==d){var Oa=n,na;(na=m.title||W&&W.title)||(na=(C=(m||document).getElementsByTagName("img")).length&&C[0].alt);Oa.title=na||d||""}"false"!==f&&(n.description=m.description||W&&W.description||f||"")}ea(I,"transform",
"translateX(-"+100*((b||1)-1)+"%)");va(b||1);U()}}
...
function Z(){S?clearTimeout(S):g(M,"menu");var a=G.autohide;S="false"!==a?setTimeout(function(){h(M,"menu");S=null},1*a||2E3):1}function Ca(a){la=!0;ma=!1;var b=Pa(a);u=document.body.clientWidth;v=document.body.clientHeight;w=L.width*y;x=L.height*y;z=w<=u;ja=b.x;ka=b.y;return p(a,!0)}function V(a){z&&ma&&(ea(I,"transform","translateX("+-(100*(E-1)-r/u*100)+"%)"),r<-(v/5)&&Y()||r>v/5&&X()||k(I,"transform","translateX(-"+100*(E-1)+"%)"),r=0,z=!1,k(J,"transform",""));la=!1;return p(a)}
function Da(a){if(la){R||(R=requestAnimationFrame(Qa));var b=Pa(a),c=(w-u)/2;ma=!0;z=w<=u;r-=ja-(ja=b.x);z?A=!0:r>c?r=c:0<u-r-w+c?r=u-w+c:A=!0;x>v&&(c=(x-v)/2,t-=ka-(ka=b.y),t>c?t=c:0<v-t-x+c?t=v-x+c:A=!0)}else Z();return p(a,!0)}function Pa(a){var b=a.touches;b&&(b=b[0]);return{x:b?b.clientX:a.pageX,y:b?b.clientY:a.pageY}}function Qa(a){A?(a&&(R=requestAnimationFrame(Qa)),k(J,"transform","translate("+r+"px, "+t+"px)")):R=null;A=!1}
function Ea(a){(a="boolean"===typeof a?a:document.isFullScreen||document.webkitIsFullScreen||document.mozFullScreen)?(document.cancelFullScreen(),h(O,"on")):(T.requestFullScreen(),g(O,"on"));return!a}function Ga(a){"boolean"===typeof a&&(B=!a);B=1===y&&!B;k(L,{maxHeight:B?"none":"",maxWidth:B?"none":"",transform:""});y=1;t=r=0;A=!0;Qa();Z()}function Ha(a){Ra(y/=.65);a||Z()}function Ra(a){k(L,"transform","translate(-50%, -50%) scale("+(a||1)+")")}
function Ia(a){var b=.65*y;1>b&&(b=1);b!==y&&(Ra(y=b),t=r=0,A=!0,Qa());a||Z()}function Na(){location.hash="spotlight";location.hash="show";La();k(M,"transition","");g(T,"hide-scrollbars");g(M,"show");Z()}function Ja(a){La(!0);history.go(!0===a?-1:-2);h(T,"hide-scrollbars");h(M,"show");Q&&Fa(!1);L.parentNode.removeChild(L);L=J=null}function X(){Q||Z();if(1<E)return E--,U(!1),!0;if(Q||H)return Sa(F)}function Y(){Q||Z();if(E<F)return E++,U(!0),!0;if(Q||H)return Sa(1)}
function Sa(a){if(a!==E){Q||Z();var b=a>E;E=a;U(b);return!0}}function ya(a){"boolean"===typeof a?D=a:(D=!D,Z());D?g(M,"white"):h(M,"white")}
...
var Ma=Element.prototype.closest||function(a){var b=this;for(a=a.substring(1);b&&1===b.nodeType;){if(b.classList.contains(a))return b;b=b.parentNode}};window.Spotlight={theme:ya,fullscreen:Ea,autofit:Ga,next:Y,prev:X,"goto":Sa,close:Ja,zoom:Ra,menu:function(a){"boolean"===typeof a&&(S=a?S:0);S?(S=clearTimeout(S),h(M,"menu")):Z();return p(a)},show:function(a,b){setTimeout(function(){a?(b?wa(b):b={},ua(a,b.index)):G={};Na()})},play:Fa};}).call(this);
