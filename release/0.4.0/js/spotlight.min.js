...
function ca(a){if(a.constructor===Array){for(var b=0;b<a.length;b++){var c=a[b];a[b]="string"===typeof c?document.querySelector(c):c}return a}return"string"===typeof a?document.querySelectorAll(a):[a]}function l(a,b){return(b||document).getElementsByClassName(a)};var m="theme fullscreen autofit zoom-in zoom-out page title description player".split(" "),q,r,fa,ha,t,u,v,w,x,y=!1,ia=!1,z=!1,A=!1,B=!1,C=!1,E,F,G,H,I,J,K,L,M,N,ja,ka,la,ma,O,oa,P,Q=null,R=null,S=null,T,pa=!0;
function qa(a,b){if(F=a.length){K||(K=l("pane",M));for(var c=K.length,d=G.title,g=G.description,e=0;e<F;e++){var n=a[e];if(e<c)var p=K[e];else p=K[0].cloneNode(!0),k(p,"left",100*e+"%"),K[0].parentNode.appendChild(p);var D=void 0;p=p.dataset;p.src=n.href||n.src;var Y=n.dataset;if("false"!==d){var Ma=p,na;(na=n.title||Y&&Y.title)||(na=(D=(n||document).getElementsByTagName("img")).length&&D[0].alt);Ma.title=na||d||""}"false"!==g&&(p.description=n.description||Y&&Y.description||g||"")}ea(I,"transform",
"translateX(-"+100*((b||1)-1)+"%)");ra(b||1);U()}}
...
V(document,"DOMContentLoaded",function(){M=document.createElement("div");M.id="spotlight";M.innerHTML='<div class=preloader style="background-image:url(img/preloader.svg)"></div><div class=scene><div class=pane></div></div><table class=header><tr><td class=page><td style="width:90%"><td class=fullscreen><img src="img/maximize.svg"><img src="img/minimize.svg"><td class=autofit><img src="img/autofit.svg"><td class=zoom-out><img src="img/zoom-out.svg"><td class=zoom-in><img src="img/zoom-in.svg"><td class=theme><img src="img/theme.svg"><td class=player><img src="img/play.svg"><img src="img/pause.svg"><td class=close><img src="img/close.svg"></table><div class="arrow arrow-left"><img src="img/arrow.svg"></div><div class="arrow arrow-right"><img src="img/arrow.svg"></div><table class=footer><tr><td class=title><tr><td class=description></table>';document.body.appendChild(M);
I=l("scene",M)[0];N=l("footer",M)[0];ja=l("title",N)[0];ka=l("description",N)[0];la=l("arrow-left",M)[0];ma=l("arrow-right",M)[0];O=l("fullscreen",M)[0];oa=l("page",M)[0];P=l("player",M)[0];document.cancelFullScreen||(document.cancelFullScreen=document.exitFullscreen||document.webkitCancelFullScreen||document.webkitExitFullscreen||document.mozCancelFullScreen||function(){});T=document.documentElement||document.body;T.requestFullScreen||(T.requestFullScreen=T.webkitRequestFullScreen||T.msRequestFullScreen||
T.mozRequestFullScreen||k(O,"display","none")||function(){});V(I,"mousedown",va);V(I,"mouseleave",wa);V(I,"mouseup",wa);V(I,"mousemove",xa);V(I,"touchstart",va,{passive:!0});V(I,"touchcancel",wa);V(I,"touchend",wa);V(I,"touchmove",xa,{passive:!0});V(O,"",ya);V(la,"",za);V(ma,"",W);V(P,"",Aa);V(l("autofit",M)[0],"",Ba);V(l("zoom-in",M)[0],"",Ca);V(l("zoom-out",M)[0],"",Da);V(l("close",M)[0],"",Ea);V(l("theme",M)[0],"",ua)});
...
function Ha(a){"boolean"===typeof a&&(S=a?S:0);S?(S=clearTimeout(S),h(M,"menu")):Z();return X(a)}function va(a){y=!0;ia=!1;var b=Ia(a);t=document.body.clientWidth;u=document.body.clientHeight;v=L.width*x;w=L.height*x;z=v<=t;fa=b.x;ha=b.y;return X(a,!0)}function wa(a){if(y&&!ia)return Ha(a);z&&(ea(I,"transform","translateX("+-(100*(E-1)-q/t*100)+"%)"),q<-(u/5)&&W()||q>u/5&&za()||k(I,"transform","translateX(-"+100*(E-1)+"%)"),q=0,z=!1,k(J,"transform",""));y=!1;return X(a)}
function xa(a){if(y){R||(R=requestAnimationFrame(Ja));var b=Ia(a),c=(v-t)/2;ia=!0;z=v<=t;q-=fa-(fa=b.x);z?A=!0:q>c?q=c:0<t-q-v+c?q=t-v+c:A=!0;w>u&&(c=(w-u)/2,r-=ha-(ha=b.y),r>c?r=c:0<u-r-w+c?r=u-w+c:A=!0)}else Z();return X(a,!0)}function Ia(a){var b=a.touches;b&&(b=b[0]);return{x:b?b.clientX:a.pageX,y:b?b.clientY:a.pageY}}function Ja(a){A?(a&&(R=requestAnimationFrame(Ja)),k(J,"transform","translate("+q+"px, "+r+"px)")):R=null;A=!1}
...
(c?" scale(0.8)":"")+(e&&"undefined"!==typeof a?" rotateY("+(a?"":"-")+"135deg)":""),maxHeight:"",maxWidth:""});g&&k(L,{opacity:1,transform:""});k(J,"transform","");k(la,"visibility",H||1!==E?"":"hidden");k(ma,"visibility",H||E!==F?"":"hidden");a=J.dataset;if(c=a.title||a.description)ja.textContent=a.title||"",ka.textContent=a.description||"";k(N,"visibility",c?"visible":"hidden");oa.textContent=E+" / "+F}
