...
function g(a){return"string"===typeof a?document.querySelectorAll(a):a};function la(a,b,c,d){ma("add",a,b,c,d)}function na(a,b,c,d){ma("remove",a,b,c,d)}function ma(a,b,c,d,e){b[a+"EventListener"](c||"click",d,"undefined"===typeof e?!0:e)}function n(a,b){a||(a=window.event);a&&(a.stopImmediatePropagation(),b||a.preventDefault(),b||(a.returnValue=!1));return!1};var p="theme fullscreen autofit zoom-in zoom-out page title description player progress".split(" "),q,r,oa,pa,u,v,w,x,A,B,qa,ra,C,D,sa,ta,E,F,G,H,ua,va,wa,I,J,K,M,N,xa,ya,za,Ba,Ca,O,Da,Ea,Fa,P,Q,Ga,R,S,T,Ha;function U(a){return(N||document).getElementsByClassName(a)[0]}
function Ia(a,b){if(F=a.length){J||(J=(N||document).getElementsByClassName("pane"));var c=J.length,d=G.title,e=G.description;T=Array(F);for(var k=0;k<F;k++){var t=a[k],y=t.dataset;if(k>=c){var z=J[0].cloneNode(!1);l(z,"left",100*k+"%");J[0].parentNode.appendChild(z)}z=void 0;var L=T,jb=k,kb=y&&(y.href||y.src)||t.src||t.href,Aa;(Aa=y&&y.title||t.title)||(Aa=(z=(t||document).getElementsByTagName("img")).length&&z[0].alt);L[jb]={src:kb,title:Aa||d||"",description:y&&y.description||t.description||e||
...
eb],[U("theme"),"",Oa]],Sa=!0)}function Wa(){u=N.clientWidth;v=N.clientHeight;K&&(w=K.width,x=K.height,fb())}function fb(){l(K,"transform","translate(-50%, -50%) scale("+A+")")}function X(a,b){l(I,"transform",a||b?"translate("+a+"px, "+b+"px)":"")}function Ja(a,b){(a?m:l)(M,"transform","translateX("+(100*-(E-1)+(b||0))+"%)")}function gb(a){for(var b=0;b<Ha.length;b++){var c=Ha[b];(a?la:na)(c[0],c[1],c[2],c[3])}}
...
function Xa(a){B=!0;qa=!1;var b=nb(a);ra=w*A<=u;oa=b.x;pa=b.y;return n(a,!0)}function Ya(a){if(B&&!qa)return B=!1,mb(a);ra&&qa&&(Ja(!0,q/u*100),q<-(v/10)&&V()||q>v/10&&ab()||Ja(),q=0,ra=!1,X());B=!1;return n(a)}function Za(a){if(B){Ga||(Ga=requestAnimationFrame(ob));var b=nb(a),c=(w*A-u)/2;qa=!0;q-=oa-(oa=b.x);ra?C=!0:q>c?q=c:0<u-q-w*A+c?q=u-w*A+c:C=!0;x*A>v&&(c=(x*A-v)/2,r-=pa-(pa=b.y),r>c?r=c:0<v-r-x*A+c?r=v-x*A+c:C=!0)}else Y();return n(a,!0)}
...
function bb(a){"boolean"===typeof a&&(D=!a);D=1===A&&!D;l(K,{maxHeight:D?"none":"",maxWidth:D?"none":"",transform:""});w=K.width;x=K.height;A=1;r=q=0;C=!0;X();Y()}function cb(a){var b=A/.65;50>=b&&(q/=.65,r/=.65,X(q,r),pb(A=b));a||Y()}function pb(a){A=a||1;fb()}function db(a){var b=.65*A;1<=b&&(q*=.65,r*=.65,X(q,r),pb(A=b));a||Y()}function ib(){location.hash="spotlight";location.hash="show";l(N,"transition","");f(S,"hide-scrollbars");f(N,"show");gb(!0);Wa();Y();G.autoplay&&W()}
function eb(a){gb(!1);history.go(!0===a?-1:-2);h(S,"hide-scrollbars");h(N,"show");Q&&W(!1);K.parentNode.removeChild(K);I=J=K=T=G=va=null}function ab(){if(1<E)return Z(E-1);if(Q||H)return m(M,"transform","translateX(-"+100*F+"%)"),Z(F)}function V(){if(E<F)return Z(E+1);if(Q||H)return 1<F&&m(M,"transform","translateX(100%)"),Z(1)}function Z(a){if(!(Q&&B||a===E)){Q||Y();Q&&ua&&lb();var b=a>E;E=a;Ka(b);return!0}}
...
function Ka(a){r=q=0;A=1;var b=G.animation,c=!0,d=!0,e=!0;if(b||""===b){c=d=e=!1;b="string"===typeof b?b.split(","):b;for(var k=0;k<b.length;k++){var t=b[k].trim();if("scale"===t)c=!0;else if("fade"===t)d=!0;else if("slide"===t)e=!0;else if("flip"===t)var y=!0;else if("false"!==t){c=d=e=y=!1;var z=t;break}}}l(M,"transition",e?"":"none");Ja();I&&X();if(K){l(K,{opacity:d?0:1,transform:""});var L=K;setTimeout(function(){L&&K!==L&&L.parentNode&&L.parentNode.removeChild(L)},800)}e=Pa();z&&f(K,z);m(K,{opacity:d?
0:1,transform:"translate(-50%, -50%)"+(c?" scale(0.8)":"")+(y&&"undefined"!==typeof a?" rotateY("+(a?"":"-")+"90deg)":""),maxHeight:"",maxWidth:""});e&&l(K,{visibility:"visible",opacity:1,transform:""});z&&h(K,z);X();l(Ba,"visibility",H||1!==E?"":"hidden");l(Ca,"visibility",H||E!==F?"":"hidden");a=T[E-1];if(c=(c=a.title||a.description)&&"false"!==c)ka(ya,a.title||""),ka(za,a.description||"");l(xa,"visibility",c?"visible":"hidden");ka(Da,E+" / "+F);va&&va(E)}
var hb=Element.prototype.closest||function(a){var b=this;for(a=a.substring(1);b&&1===b.nodeType;){if(b.classList.contains(a))return b;b=b.parentElement||b.parentNode}};window.Spotlight={init:Ra,theme:Oa,fullscreen:$a,autofit:bb,next:V,prev:ab,"goto":Z,close:eb,zoom:pb,menu:mb,show:function(a,b){setTimeout(function(){a?(b?Ma(b):b={},Ia(a,b.index)):G={};ib()})},play:W};}).call(this);
