...
function lb(a,b){G=H[a-1];I=G.firstChild;x=a;if(I)v&&R(),ua&&d(I,ua),jb(!0),E&&g(I,E),Ca&&h(I,"opacity",1),Ba&&h(I,"transform",""),h(I,"visibility","visible"),b&&Pa&&(document.createElement("img").src=Pa);else{var c=M.media,e=W("spinner",!0);if("video"===c)X(e,!0),I=document.createElement("video"),I.onloadedmetadata=function(){I.width=I.videoWidth;I.height=I.videoHeight;Y();X(e);lb(a,b)},I.poster=A.poster,I.preload=xa?"auto":"metadata",I.controls=W("controls",!0),I.autoplay=D,I.h=W("inline"),I.muted=
W("muted"),I.src=M.src,G.appendChild(I);else{if("node"===c){I=M.src;"string"===typeof I&&(I=document.querySelector(I));I&&(I.g||(I.g=I.parentNode),Y(),G.appendChild(I),lb(a,b));return}X(e,!0);I=document.createElement("img");I.onload=function(){X(e);lb(a,b);Y()};I.src=M.src;G.appendChild(I)}I&&(e||h(I,"visibility","visible"),I.onerror=function(){G.removeChild(I);I=null;d(Oa,"error");X(e)})}}function X(a,b){a&&(b?d:g)(Oa,"spin")}
