...
F,L.h=Y("inline"),L.muted=Y("muted"),L.src=O.src,J.appendChild(L)):"node"===c?(L=O.src,"string"===typeof L&&(L=document.querySelector(L)),L.g||(L.g=L.parentNode),jb(),e&&g(l,"spinner"),J.appendChild(L),ib(a,b)):(L=document.createElement("img"),L.onload=function(){e&&g(l,"spinner");u=L.width;v=L.height;ib(a,b)},L.onerror=function(){J.removeChild(this)},L.src=O.src,J.appendChild(L));L&&(e||h(L,"visibility","visible"))}}
