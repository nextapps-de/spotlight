...
function ca(a){if(a.constructor===Array){for(var b=0;b<a.length;b++){var c=a[b];a[b]="string"===typeof c?document.querySelector(c):c}return a}return"string"===typeof a?document.querySelectorAll(a):[a]}function l(a,b){return(b||document).getElementsByClassName(a)};function fa(a,b,c,d){ha("add",a,b,c,d)}function ia(a,b,c,d){ha("remove",a,b,c,d)}function ha(a,b,c,d,e){b[a+"EventListener"](c||"click",d,"undefined"===typeof e?!0:e)}function p(a,b){a||(a=window.event);a&&(b||a.preventDefault(),a.stopImmediatePropagation(),a.returnValue=!1);return!1};var q="theme fullscreen autofit zoom-in zoom-out page title description player".split(" "),r,t,ja,ka,u,v,w,x,y,z=!1,A=!1,B=!1,D=!1,E=!1,F=!1,G,H,I,J,K,L,M,N,O,P,la,ma,oa,pa,Q,qa,R,S=null,T=null,U=null,V,ra;
function sa(a,b){if(H=a.length){M||(M=l("pane",O));for(var c=M.length,d=I.title,e=I.description,g=0;g<H;g++){var m=a[g];if(g<c)var n=M[g];else n=M[0].cloneNode(!0),k(n,"left",100*g+"%"),M[0].parentNode.appendChild(n);var C=void 0;n=n.dataset;n.src=m.href||m.src;var Y=m.dataset;if("false"!==d){var Pa=n,na;(na=m.title||Y&&Y.title)||(na=(C=(m||document).getElementsByTagName("img")).length&&C[0].alt);Pa.title=na||d||""}"false"!==e&&(n.description=m.description||Y&&Y.description||e||"")}ea(K,"transform",
"translateX(-"+100*((b||1)-1)+"%)");ta(b||1);W()}}
...
function Z(){U?clearTimeout(U):f(O,"menu");var a=I.autohide;U="false"!==a?setTimeout(function(){h(O,"menu");U=null},1*a||2E3):1}function Oa(a){"boolean"===typeof a&&(U=a?U:0);U?(U=clearTimeout(U),h(O,"menu")):Z();return p(a)}function Aa(a){z=!0;A=!1;var b=Qa(a);u=document.body.clientWidth;v=document.body.clientHeight;w=N.width*y;x=N.height*y;B=w<=u;ja=b.x;ka=b.y;return p(a,!0)}
function Ba(a){if(z&&!A)return z=!1,Oa(a);B&&A&&(ea(K,"transform","translateX("+-(100*(G-1)-r/u*100)+"%)"),r<-(v/10)&&X()||r>v/10&&Ea()||k(K,"transform","translateX(-"+100*(G-1)+"%)"),r=0,B=!1,k(L,"transform",""));z=!1;return p(a)}function Ca(a){if(z){T||(T=requestAnimationFrame(Ra));var b=Qa(a),c=(w-u)/2;A=!0;B=w<=u;r-=ja-(ja=b.x);B?D=!0:r>c?r=c:0<u-r-w+c?r=u-w+c:D=!0;x>v&&(c=(x-v)/2,t-=ka-(ka=b.y),t>c?t=c:0<v-t-x+c?t=v-x+c:D=!0)}else Z();return p(a,!0)}
function Qa(a){var b=a.touches;b&&(b=b[0]);return{x:b?b.clientX:a.pageX,y:b?b.clientY:a.pageY}}function Ra(a){D?(a&&(T=requestAnimationFrame(Ra)),k(L,"transform","translate("+r+"px, "+t+"px)")):T=null;D=!1}function Da(a){(a="boolean"===typeof a?a:document.isFullScreen||document.webkitIsFullScreen||document.mozFullScreen)?(document.cancelFullScreen(),h(Q,"on")):(V.requestFullScreen(),f(Q,"on"));return!a}
function Ga(a){"boolean"===typeof a&&(E=!a);E=1===y&&!E;k(N,{maxHeight:E?"none":"",maxWidth:E?"none":"",transform:""});y=1;t=r=0;D=!0;Ra();Z()}function Ha(a){Sa(y/=.65);a||Z()}function Sa(a){k(N,"transform","translate(-50%, -50%) scale("+(a||1)+")")}function Ia(a){var b=.65*y;1>b&&(b=1);b!==y&&(Sa(y=b),t=r=0,D=!0,Ra());a||Z()}function Na(){location.hash="spotlight";location.hash="show";La();k(O,"transition","");f(V,"hide-scrollbars");f(O,"show");Z()}
function Ja(a){La(!0);history.go(!0===a?-1:-2);h(V,"hide-scrollbars");h(O,"show");S&&Fa(!1);N.parentNode.removeChild(N);N=L=null}function Ea(){S||Z();if(1<G)return G--,W(!1),!0;if(S||J)return Ta(H)}function X(){S||Z();if(G<H)return G++,W(!0),!0;if(S||J)return Ta(1)}function Ta(a){if(a!==G){S||Z();var b=a>G;G=a;W(b);return!0}}function wa(a){"boolean"===typeof a?F=a:(F=!F,Z());F?f(O,"white"):h(O,"white")}
...
(c?" scale(0.8)":"")+(g&&"undefined"!==typeof a?" rotateY("+(a?"":"-")+"135deg)":""),maxHeight:"",maxWidth:""});e&&k(N,{opacity:1,transform:""});k(L,"transform","");k(oa,"visibility",J||1!==G?"":"hidden");k(pa,"visibility",J||G!==H?"":"hidden");a=L.dataset;if(c=a.title||a.description)la.textContent=a.title||"",ma.textContent=a.description||"";k(P,"visibility",c?"visible":"hidden");qa.textContent=G+" / "+H}
var Ma=Element.prototype.closest||function(a){var b=this;for(a=a.substring(1);b&&1===b.nodeType;){if(b.classList.contains(a))return b;b=b.parentNode}};window.Spotlight={theme:wa,fullscreen:Da,autofit:Ga,next:X,prev:Ea,"goto":Ta,close:Ja,zoom:Sa,menu:Oa,show:function(a,b){setTimeout(function(){a?(b?ua(b):b={},sa(a,b.index)):I={};Na()})},play:Fa};}).call(this);
